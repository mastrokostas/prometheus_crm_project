...
class EditLegalForm(forms.ModelForm):
    ...
    company_phone = forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={"placeholder":"Company Phone Number", "class":"form-control"}), label="Company Phone Number:")
