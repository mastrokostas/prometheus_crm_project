...
class AddTenantForm(forms.ModelForm):
    ...
    first_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"First Name", "class":"form-control"}), label="*Required") #, label="*Required"
    last_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Last Name", "class":"form-control"}), label="*Required") #, label="*Required"
    ...
    tax_id = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Tax ID Number", "class":"form-control"}), label="*Required") #, label="*Required"
    ...
    id_number = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"ID or Passport Number", "class":"form-control"}), label="*Required") #, label="*Required"
