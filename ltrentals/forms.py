...
class AddRentalAgreement(forms.ModelForm):
    ...
    security_deposits = forms.IntegerField(required=True, widget=forms.widgets.NumberInput(attrs={"class":"form-control"}), label="Security Deposits Paid:")
